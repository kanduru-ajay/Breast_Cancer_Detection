...
class Dataset(models.Model):
    ...
    positive_count = models.IntegerField(null=True)   # malignant
    negative_count = models.IntegerField(null=True)   # benign
    class_balance = models.FloatField(null=True)      # malignant ratio
